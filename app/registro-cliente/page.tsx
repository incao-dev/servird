        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="bg-white border border-gray-100 rounded-2xl p-10 max-w-md w-full text-center">
            ...
            <p className="text-gray-500 mb-6 leading-relaxed">
              Ya puedes iniciar sesión y publicar tu primer trabajo.
            </p>
            <Link
              href="/login-cliente"
      ...
      <div className="max-w-md mx-auto px-4 py-14">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500">
            Publica trabajos y recibe cotizaciones de proveedores verificados.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-5">
          ¿Ya tienes cuenta?{" "}
          <Link href="/login-cliente" className="text-[#1a1a1a] font-bold hover:underline">
            Inicia sesión
          </Link>
        </p>
      </div>
